...
var assertUrlFileExists = function(url) {
    ...
    var request = http.get(url.toString(), function(response) {
        response.pipe(file);
    });
...
if(require.main == module) {
    program
        ...
        .option('-f, --url <url>', 'Path to index.html', clone(assertUrlFileExists), HTMLFILE_DEFAULT)
        .parse(process.argv);
